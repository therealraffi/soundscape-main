...
def avgfreq(block):
        ...
        return -1 if math.isnan(float(out)) or len(freqdict) == 0 else max(1, int(out))
...
#            print(len(fm), prevlen, back, len(filtered))
...
#                print(freq, "|" * amp)
    ...
    #        print(time.time() - t1)
            ...
            channels = np.frombuffer(filterout, dtype='int16')
            ...
            sound.child("sound1").child("amplitude").set(amplitude(c0))
            sound.child("sound1").child("frequency").set(avgfreq(c0))

            sound.child("sound2").child("amplitude").set(amplitude(c1))
            sound.child("sound2").child("frequency").set(avgfreq(c1))

            sound.child("sound3").child("amplitude").set(amplitude(c2))
            sound.child("sound3").child("frequency").set(avgfreq(c2))

            sound.child("sound4").child("amplitude").set(amplitude(c3))
            sound.child("sound4").child("frequency").set(avgfreq(c3))
#            print(time.time() - t1)
